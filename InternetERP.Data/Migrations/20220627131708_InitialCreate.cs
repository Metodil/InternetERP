        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExparedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "getdate()"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountPhone", x => new { x.AccountsId, x.PhonesId });
                    table.ForeignKey(
                        name: "FK_AccountPhone_Accounts_AccountsId",
                        column: x => x.AccountsId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountPhone_Phones_PhonesId",
                        column: x => x.PhonesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Failures_Accounts_AccountId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeePhone", x => new { x.EmployeesId, x.PhonesId });
                    table.ForeignKey(
                        name: "FK_EmployeePhone_Employees_EmployeesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FailuresParts", x => new { x.FailureId, x.PartId });
                    table.ForeignKey(
                        name: "FK_FailuresParts_Failures_FailureId",
                        column: x => x.FailureId,
                        principalTable: "Failures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FailuresParts_Parts_PartId",
                        column: x => x.PartId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Feedbacks_Failures_FailureId",
                        column: x => x.FailureId,
                        principalTable: "Failures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountId = table.Column<int>(type: "int", nullable: false),
                    FailureId = table.Column<int>(type: "int", nullable: false),
                    InternetPayment = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    FailurePayment = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreateDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "getdate()"),
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Payments_Failures_FailureId",
                        column: x => x.FailureId,
                        principalTable: "Failures",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommentFeedback", x => new { x.CommentsId, x.FeedbacksId });
                    table.ForeignKey(
                        name: "FK_CommentFeedback_Comments_CommentsId",
                        column: x => x.CommentsId,
                        principalTable: "Comments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CommentFeedback_Feedbacks_FeedbacksId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommentFeedback_FeedbacksId",
                table: "CommentFeedback",
                column: "FeedbacksId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FailuresParts_PartId",
                table: "FailuresParts",
                column: "PartId");

            migrationBuilder.CreateIndex(
                name: "IX_Feedbacks_FailureId",
                table: "Feedbacks",
                column: "FailureId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_FailureId",
                table: "Payments",
                column: "FailureId");

            migrationBuilder.CreateIndex(
                name: "IX_StatusFailures_Name",
