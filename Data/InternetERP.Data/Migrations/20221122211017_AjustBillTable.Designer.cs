...
namespace InternetERP.Data.Migrations
{
    ...
    [Migration("20221122211017_AjustBillTable")]
    partial class AjustBillTable
    {
            ...
            modelBuilder.Entity("InternetERP.Data.Models.Failure", b =>
                {
                    ...
                    b.HasOne("InternetERP.Data.Models.StatusBill", null)
                        .WithMany("Failures")
                        .HasForeignKey("StatusBillId");
